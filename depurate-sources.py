...
def depure(directory):
    ...
    table_columns = {
        ...
        personas_table: ['PERNA01','pobpcoac', 'PerDi01', 'PerDi05', 'PerDi02', 'PerPa01', 'PerMi02_1', 'PerMi05_1', 'PerEd03_r', 'PerEd03_1', 'PerEd03_2', 'PerEd05_r', 'PerEd06_r', 'PerFM01', 'PerFM01_1', 'PerFM02', 'PerFM02_1', 'PerFM04_2', 'niveledu_r', 'v66', 'PerFM01_r', 'PerFM02_r']
    }
